...
winget update --id Canonical.Multipass --silent --accept-package-agreements --accept-source-agreements
::
...
:: WEB BROWSERS
:: 
winget update --id Brave.Brave --silent --accept-package-agreements --accept-source-agreements
winget update --id Microsoft.Edge --silent --accept-package-agreements --accept-source-agreements
winget update --id Google.Chrome --silent --accept-package-agreements --accept-source-agreements
winget update --id Mozilla.Firefox --silent --accept-package-agreements --accept-source-agreements
::
