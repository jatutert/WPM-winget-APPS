...
if %errorlevel% neq 0 (
  ...
  winget upgrade --id Microsoft.VCRedist.2005.x86 --accept-package-agreements --accept-source-agreements
)
...
if %errorlevel% neq 0 (
  ...
  winget upgrade --id Microsoft.VCRedist.2008.x86 --accept-package-agreements --accept-source-agreements
)
...
if %errorlevel% neq 0 (
  ...
  winget upgrade --id Microsoft.VCRedist.2010.x86 --accept-package-agreements --accept-source-agreements
)
...
if %errorlevel% neq 0 (
  ...
  winget upgrade --id Microsoft.VCRedist.2012.x86 --accept-package-agreements --accept-source-agreements
)
...
if %errorlevel% neq 0 (
  ...
  winget upgrade --id Microsoft.VCRedist.2013.x86 --accept-package-agreements --accept-source-agreements
)
::
...
::
:: PatchMyPC
curl -s -o %USERPROFILE%\Downloads\PatchMyPC.exe https://patchmypc.com/freeupdater/PatchMyPC.exe
::
::
goto :tools 
:: 
