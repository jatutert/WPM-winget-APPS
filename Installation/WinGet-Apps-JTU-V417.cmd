...
@REM    powershell -command "Set-WinHomeLocation -GeoId 244"
@REM    powershell -command "Start-Sleep -Seconds 20"
@REM
@REM
...
if %systeem_menu_antwoord%==6 goto :prntrtls
if %systeem_menu_antwoord%==5 goto :utilsystls
if %systeem_menu_antwoord%==4 goto :syscusttwk
if %systeem_menu_antwoord%==3 goto :other
if %systeem_menu_antwoord%==2 goto :flmbck
if %systeem_menu_antwoord%==1 goto :appmgrs
goto :systeem
@REM
@REM 1-1
:appmgrs
...
@REM 1-2
:flmbck
@REM winget install JumpingBytes.PureSync.Personal --accept-package-agreements --accept-source-agreements
...
winget install JAMSoftware.TreeSize.Free --accept-package-agreements --accept-source-agreements
...
@REM winget install Microsoft.WindowsTerminal.Preview --accept-package-agreements --accept-source-agreements
@REM
@REM
goto :systeem
@REM
...
if %development_menu_antwoord%==1 goto :devopstls
goto :development
@REM
@REM 2-1
:devopstls
...
if %internet_menu_antwoord%==3 goto :browsers
if %internet_menu_antwoord%==2 goto :ntwrkonline
if %internet_menu_antwoord%==1 goto :message
goto :internet
::
@REM 3-1
:message
...
@REM VPN Tool winget install WireGuard.WireGuard --accept-package-agreements --accept-source-agreements
winget install SURF.eduVPNClient --accept-package-agreements --accept-source-agreements
winget install WiresharkFoundation.Wireshark --accept-package-agreements --accept-source-agreements
@REM WiFi Analyzer
winget install 9NBLGGH33N0N --accept-package-agreements --accept-source-agreements
@REM Vistumbler
winget install AndrewCalcutt.Vistumbler --accept-package-agreements --accept-source-agreements
@REM
goto :internet
@REM
@REM 3-3
...
if %multimedia_menu_antwoord%==3 goto :mmtools
if %multimedia_menu_antwoord%==2 goto :mmimgraph
if %multimedia_menu_antwoord%==1 goto :mmgame
goto :multimedia
::
@REM 4
:mmgame
...
if %office_menu_antwoord%==1 goto :officeprod
goto :office
::
@REM 5
:officeprod
...
if %security_menu_antwoord%==1 goto :sectools
goto :security
@REM
@REM
:sectools
...
@REM    Powershell -command "Set-WinHomeLocation -GeoId 176"
exit /b 0